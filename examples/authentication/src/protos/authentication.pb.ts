...
export const CurrentUserJSON = {
   ...
   */
  encode: function (msg: Partial<CurrentUser>): string {
   ...
   * @private
   */
  _writeMessage: function (msg: Partial<CurrentUser>): Record<string, unknown> {
...
export const CredentialsJSON = {
   ...
   */
  encode: function (msg: Partial<Credentials>): string {
   ...
   * @private
   */
  _writeMessage: function (msg: Partial<Credentials>): Record<string, unknown> {
    const json: Record<string, unknown> = {};
    if (msg.username) {
      json.username = msg.username;
    }
